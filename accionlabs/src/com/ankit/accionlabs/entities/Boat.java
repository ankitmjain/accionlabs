...
public class Boat extends Vehicle implements Serializable {
	public Boat(int id,String name,String vehicleType, String make, String modal, String modeOfTranport,
	...
	public Boat(String vehicleType,String make,String modal,String modeOfTranport,String carType,String controlType,String numberofWheels,String numberofSeats) {
